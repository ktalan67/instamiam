...
class __TwigTemplate_f500af3b97d69db3c987212f49ecf1a4f9351d7981dc470f6eb77baf55b1bfca extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 27
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "roleId", [], "any", false, false, false, 27), "html", null, true);
            echo "</td>
                <td>";
            // line 28
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "isActive", [], "any", false, false, false, 28)) ? ("Yes") : ("No"));
            echo "</td>
                <td><img class=\"img-profil-mini\" src=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("images/users/min/" . twig_get_attribute($this->env, $this->source, $context["user"], "imageFilename", [], "any", false, false, false, 29))), "html", null, true);
            echo "\"></td>
                <td>
                    <a href=\"";
            // line 31
            ...
            echo "\">show</a>
                    <a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td><img class=\"img-profil-mini\" src=\"{{ asset('images/users/min/' ~ user.imageFilename) }}\"></td>
                <td>
