...
class __TwigTemplate_ce73a939ab39f56606bebbd04a2d013a54ac1604fe52e75916d0ee2794d3fd8d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), "imageFile", [], "any", false, false, false, 2), 'row');
        echo "
    <button class=\"btn\">";
        // line 3
...
", "user/_form.html.twig", "/var/www/html/instamiam/templates/user/_form.html.twig");
    }
}
