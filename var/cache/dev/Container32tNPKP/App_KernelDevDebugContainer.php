...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\GenresRepository' => ['privates', 'App\\Repository\\GenresRepository', 'getGenresRepositoryService', false],
            'App\\Repository\\PhotoRepository' => ['privates', 'App\\Repository\\PhotoRepository', 'getPhotoRepositoryService', false],
            'App\\Repository\\RecettesRepository' => ['privates', 'App\\Repository\\RecettesRepository', 'getRecettesRepositoryService', false],
            ...
            'App\\Repository\\GenresRepository' => '?',
    ...
    /**
     * Gets the private 'App\Repository\GenresRepository' shared autowired service.
     *
     * @return \App\Repository\GenresRepository
     */
    protected function getGenresRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/GenresRepository.php';

        return $this->privates['App\\Repository\\GenresRepository'] = new \App\Repository\GenresRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getRecettesRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        return $this->privates['App\\Repository\\RecettesRepository'] = new \App\Repository\RecettesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
